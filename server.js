...
const bodyParser = require('body-parser'); // Importa bodyParser aquí
...
app.get('/inicio', (req, res) => {
    let inicio = "Valor de inicio"; // Define el valor de inicio que deseas pasar a la plantilla
    res.render('inicio', { title: 'Inicio de Sesión', inicio: inicio });
});

app.get('/registro', (req, res) => {
    res.render('registro'); // Renderiza la vista "registro.pug"
  });

  // Manejar la solicitud de registro
app.post('/registro', (req, res) => {
    // Aquí debes procesar los datos del formulario y crear un nuevo cliente en tu sistema
    const { nombre, email, password } = req.body;
    const nuevoCliente = { nombre, email, password };
  
    // Aquí deberías agregar la lógica para guardar el nuevo cliente en tu sistema

    // Autenticar al cliente después de registrarse
    req.session.cliente = nuevoCliente; // Esto es solo un ejemplo, debes ajustarlo según tu sistema de autenticación
  
    res.redirect('/catalogo'); // Redirigir al cliente a la página de catálogo después del registro
});

// Configurar body-parser para procesar solicitudes POST
